...
class TestOfIMConexaoBancoDados extends BaseUnitTest {
   ...
   public function testOfquery()
   {
      ...
      $this->assertTrue( get_class($result) == 'IMPDOStatement' , 'Erro na execuчуo de uma query com prepare' );    
   }
   ...
   public function testOfexecuta()
   {
      ...
      $this->assertTrue( $result == 1, 'Erro na execuчуo de uma query com exec' );       
