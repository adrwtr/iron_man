...
class SimpleFrameset {
    ...
    function getFrameFocus() {
        ...
        return array_merge(
                ...
                (array) $this->_frames[$this->_focus]->getFrameFocus());
    }
    ...
    function getUrls() {
        ...
        foreach ($this->_frames as $frame) {
            $urls = array_merge((array)$urls, (array)$frame->getUrls());
        }
    ...
    function getUrlsByLabel($label) {
        ...
        foreach ($this->_frames as $index => $frame) {
            $urls = array_merge(
                    (array)$urls,
                    (array)$this->_tagUrlsWithFrame(
                                (array) $frame->getUrlsByLabel($label),
                                (array) $index));
        }
        return $urls;
    }
