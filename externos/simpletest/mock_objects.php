...
class MockGenerator {
    ...
    function _createSubclassCode($methods) {
        ...
        $code .= "    var \$_mock;\n";
        $code .= $this->_addMethodList(array_merge((array)$methods, (array)$this->_reflection->getMethods()));
        $code .= "\n";
        $code .= "    function " . $this->_mock_class . "() {\n";
    ...
    function _createHandlerCode($methods) {
        $code = '';
        $methods = array_merge((array)$methods, (array)$this->_reflection->getMethods());
