...
/**
 * Classe que representa um resultado de uma execuчуo SQL
 * da classe PDO
 */
class IMResultado {
    ...
    * @param  [bool] [completo] [indica se щ para preencher completo]
    ...
    * 
    * @param  [array]
    * @return [array] com as igualdades e diferenчas
    */
