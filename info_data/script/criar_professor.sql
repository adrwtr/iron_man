...
set @cd_pessoa       := 15;
set @nome_professor  := 'Professor 2';




select * from estnc_alunos where cd_pessoa = @cd_pessoa;
select * from nu_grupos_pessoas where cd_pessoa = @cd_pessoa;
select * from pessoas where cd_pessoa = @cd_pessoa;
select * from contatos_pessoas where cd_pessoa = @cd_pessoa;
...
VALUES 
( @cd_pessoa, NULL, NULL, 0, 0, @nome_professor, NULL, '2013-09-12 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
 '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2013-09-12 00:00:00', '63469405700', NULL, NULL, 0, NULL, NULL, NULL, NULL, 
 NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Professor ', NULL, NULL, 'Professor ', NULL, 
...
INSERT INTO `nu_grupos_pessoas` (`cd_grupo_pessoa`, `cd_grupo`, `cd_pessoa`, `cd_coligada`) VALUES 
(null, (select cd_grupo from nu_grupos where ds_papel='PROFESSOR' limit 1), @cd_pessoa, 1);
